...
common-$(CONFIG_HOST_CONTROL_GPIO) += host_control_gpio.o
...
common-$(CONFIG_I2C_MUX)+=i2c_mux.o
...
common-$(CONFIG_RESET_BUTTON)+=reset_button.o
common-$(CONFIG_PWRSUP)+=pwrsup.o
