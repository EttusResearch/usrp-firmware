...
#define STM32_TIM_CCER_CC2P		BIT(5)
...
#define STM32_TIM_SR_CC2OF		BIT(10)
#define STM32_TIM_SR_CC1OF		BIT(9)
#define STM32_TIM_SR_CC2IF		BIT(2)
#define STM32_TIM_SR_CC1IF		BIT(1)
#define STM32_TIM_SR_UIF		BIT(0)

#define STM32_TIM_CCMR_ICF2F_3		BIT(15)
#define STM32_TIM_CCMR_ICF2F_2		BIT(14)
#define STM32_TIM_CCMR_ICF2F_1		BIT(13)
#define STM32_TIM_CCMR_ICF2F_0		BIT(12)
#define STM32_TIM_CCMR_IC2_PSC_1	BIT(11)
#define STM32_TIM_CCMR_IC2_PSC_0	BIT(10)
#define STM32_TIM_CCMR_CC2S_1		BIT(9)
#define STM32_TIM_CCMR_CC2S_0		BIT(8)

#define STM32_TIM_CCMR_ICF1F_3		BIT(7)
#define STM32_TIM_CCMR_ICF1F_2		BIT(6)
#define STM32_TIM_CCMR_ICF1F_1		BIT(5)
#define STM32_TIM_CCMR_ICF1F_0		BIT(4)
#define STM32_TIM_CCMR_IC1_PSC_1	BIT(3)
#define STM32_TIM_CCMR_IC1_PSC_0	BIT(2)
#define STM32_TIM_CCMR_CC1S_1		BIT(1)
#define STM32_TIM_CCMR_CC1S_0		BIT(0)
#define STM32_TIM_DIER_CC1OF		BIT(9)
#define STM32_TIM_DIER_CC2IE		BIT(2)
